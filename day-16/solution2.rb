...
(0..(input_data.length - 1)).each do |i|
  multiple.push(solve(input_data, output_data, 0, i, Direction::RIGHT))
  multiple.push(solve(input_data, output_data, input_data[0].length - 1, i, Direction::LEFT))
end

(0..(input_data[0].length - 1)).each do |i|
  multiple.push(solve(input_data, output_data, i, 0, Direction::DOWN))
  multiple.push(solve(input_data, output_data, i, input_data.length - 1, Direction::UP))
end
